...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container">
        ...
        <div class="row">
          ...
          <h2><span class="badge badge-warning badge-pill"> Comments</span></h2>
        </div>
        <div class="row">

            <div class="col-md-5">
         <asp:panel runat="server"  ID="txtyu">
               <asp:Repeater ID="repcom"  runat="server">
                    <ItemTemplate>
                      <div class="divDet1 pt-2">
                            <h1 class="proNameView"><%#Eval("Name") %></h1>
                            <p class="proPriceView"><%#Eval("review") %></p>

                        </div>
                    <asp:HiddenField ID="kdaID" Value='<%# Eval("id") %>' runat="server" />
        ...
        <div class="row">
            <div class="col">
                <asp:TextBox runat="server" TextMode="MultiLine" CssClass="form-control" ID="txtcomm"></asp:TextBox>
            </div>
            <div class="form-group">
                <asp:Button runat="server" ID="btncomm" Text="Post" CssClass="btn btn-block btn-warning btn-lg" OnClick="btncomm_Click" />
            </div>
        </div>
        </div>
            </div>
